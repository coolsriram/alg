package com.alg.sedgewick.utils.fromsite; /*************************************************************************
 ...
 *  <p>
 *  Like {@link java.util.Scanner}, reading a <em>token</em> also consumes preceding Java
...
public final class StdIn {
   ...
   /**
     ...
     * @throws java.util.InputMismatchException if the next token cannot be parsed as an <tt>int</tt>
     */
   ...
   /**
     ...
     * @throws java.util.InputMismatchException if the next token cannot be parsed as a <tt>double</tt>
     */
   ...
   /**
     ...
     * @throws java.util.InputMismatchException if the next token cannot be parsed as a <tt>float</tt>
     */
   ...
   /**
     ...
     * @throws java.util.InputMismatchException if the next token cannot be parsed as a <tt>long</tt>
     */
   ...
   /**
     ...
     * @throws java.util.InputMismatchException if the next token cannot be parsed as a <tt>short</tt>
     */
   ...
   /**
     ...
     * @throws java.util.InputMismatchException if the next token cannot be parsed as a <tt>byte</tt>
     */
     ...
     * @throws java.util.InputMismatchException if the next token cannot be parsed as a <tt>boolean</tt>:
     ...
     * @throws java.util.InputMismatchException if any token cannot be parsed as an <tt>int</tt>
     */
     ...
     * @throws java.util.InputMismatchException if any token cannot be parsed as a <tt>double</tt>
     */
